...
for undersamplingfac=[1,2,3,4,5]
...
%     errorbar(cp+dr,squeeze(mean_HARPI_CC(spa_,noi_,:)),squeeze(std_HARPI_CC(spa_,noi_,:)),'o',...
...
% Make plot nice
nice_plot_uCC(axis_font_size,axis_line_width,legend_font_size,[0.5 5.5 0 30])

% Turn off plots
hold off

% Print plots
print('-depsc','-r600', [figures_dir,'Figure_7']);
print('-dpng','-r600', [figures_dir,'Figure_7'])